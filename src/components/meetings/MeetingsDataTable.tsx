...
import type { MeetingWithAgent } from "./meeting-ui.types";
...
export function MeetingsDataTable({ meetings, agents, onRefresh }: MeetingsDataTableProps) {
    ...
    const handleDelete = (meeting: MeetingWithAgent) => {
    ...
    const getAgentName = (meeting: MeetingWithAgent) => {
    ...
    // Define columns
    const columns: Column<MeetingWithAgent>[] = [
        {
            key: "name",
            header: "Meeting",
            sortable: true,
