...
import type { CreateMeetingInput, MeetingsFilterParams } from "@/modules/meetings";
import Link from "next/link";

const meetingStatusFilters = ["all", "upcoming", "active", "completed", "processing", "cancelled"] as const;

function isMeetingStatusFilter(value: string): value is MeetingsFilterParams["status"] {
    return meetingStatusFilters.includes(value as MeetingsFilterParams["status"]);
}
...
export default function MeetingsPage() {
    ...
    const selectedStatus = isMeetingStatusFilter(status) ? status : "all";
